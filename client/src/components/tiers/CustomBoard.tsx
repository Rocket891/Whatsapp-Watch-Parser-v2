...
/**
 * Self-contained drag-drop custom tier board. Renders WITHOUT any page shell
 * (no Sidebar/Topbar) — just the controls bar down. Mountable inside a tab or
 * any other container. Owns its own data fetching, board state, and native
 * HTML5 drag-drop, exactly as the original custom-tiers page did.
 */
