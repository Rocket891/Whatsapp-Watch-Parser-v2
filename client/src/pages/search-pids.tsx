...
import { ArrowUpDown, Search, Download, Send, X } from "lucide-react";
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Topbar title="Search PIDs" subtitle="Search and filter watch listings by PID, brand, and other criteria" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <GroupSelect
                ...
                onValueChange={(value) => setFilters(prev => ({ ...prev, groupName: value === 'all' ? '' : value }))}
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button 
                onClick={() => sendWhatsAppMutation.mutate({ phone: sendingTo!, message: customMessage })}
                disabled={!customMessage.trim() || sendWhatsAppMutation.isPending}
              >
